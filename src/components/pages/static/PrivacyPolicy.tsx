...
const PrivacyPolicy: React.FC = () => {
  return (
    <MuiContainer maxWidth="md">
      <StyledH1>プライバシーポリシー</StyledH1>
      <StyledText>
        COMPASSの運営者（以下、「当方」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
      </StyledText>

      <StyledH2>第1条（個人情報）</StyledH2>
      <StyledText>
        「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
      </StyledText>

      <StyledH2>第2条（個人情報の収集方法）</StyledH2>
      <StyledText>
      ...
      <StyledH2>第3条（個人情報を収集・利用する目的）</StyledH2>
      <StyledText>当方が個人情報を収集・利用する目的は、以下のとおりです。</StyledText>
      <StyledOrderList>
        <StyledOrderListItem>当方サービスの提供・運営のため</StyledOrderListItem>
        <StyledOrderListItem>ユーザーからのお問い合わせに回答するため（本人確認を行うことを含む）</StyledOrderListItem>
        <StyledOrderListItem>
          ユーザーが利用中のサービスの新機能、更新情報、キャンペーン等及び当方が提供する他のサービスの案内のメールを送付するため
        </StyledOrderListItem>
        <StyledOrderListItem>メンテナンス、重要なお知らせなど必要に応じたご連絡のため</StyledOrderListItem>
        <StyledOrderListItem>
        ...
        <StyledOrderListItem>有料サービスにおいて、ユーザーに利用料金を請求するため</StyledOrderListItem>
        <StyledOrderListItem>上記の利用目的に付随する目的</StyledOrderListItem>
      </StyledOrderList>

      <StyledH2>第4条（利用目的の変更）</StyledH2>
      <StyledOrderList>
        <StyledOrderListItem>
      ...
      <StyledH2>第5条（個人情報の第三者提供）</StyledH2>
      <StyledOrderList>
        <StyledOrderListItem>
          ...
          <StyledOrderList>
            ...
            <StyledOrderListItem>
              ...
              <StyledOrderList>
                <StyledOrderListItem>利用目的に第三者への提供を含むこと</StyledOrderListItem>
                <StyledOrderListItem>第三者に提供されるデータの項目</StyledOrderListItem>
                <StyledOrderListItem>第三者への提供の手段または方法</StyledOrderListItem>
                <StyledOrderListItem>本人の求めに応じて個人情報の第三者への提供を停止すること</StyledOrderListItem>
                <StyledOrderListItem>本人の求めを受け付ける方法</StyledOrderListItem>
              </StyledOrderList>
            </StyledOrderListItem>
          </StyledOrderList>
        </StyledOrderListItem>
        <StyledOrderListItem>
          ...
          <StyledOrderList>
            ...
            <StyledOrderListItem>合併その他の事由による事業の承継に伴って個人情報が提供される場合</StyledOrderListItem>
            <StyledOrderListItem>
      ...
      <StyledOrderList>
        <StyledOrderListItem>
          ...
          <StyledOrderList>
            ...
            <StyledOrderListItem>当方の業務の適正な実施に著しい支障を及ぼすおそれがある場合</StyledOrderListItem>
            <StyledOrderListItem>その他法令に違反することとなる場合</StyledOrderListItem>
          </StyledOrderList>
        </StyledOrderListItem>
        <StyledOrderListItem>
      ...
      <StyledH2>第7条（個人情報の訂正および削除）</StyledH2>
      <StyledOrderList>
        <StyledOrderListItem>
      ...
      <StyledH2>第8条（個人情報の利用停止等）</StyledH2>
      <StyledOrderList>
        <StyledOrderListItem>
      ...
      <StyledH2>第9条（プライバシーポリシーの変更）</StyledH2>
      <StyledOrderList>
        <StyledOrderListItem>
