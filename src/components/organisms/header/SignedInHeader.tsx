...
const SignedInHeader: React.FC = React.memo(() => {
  ...
  return (
    <Box sx={{ flexGrow: 1, height: "64px" }}>
      <AppBar position="relative" sx={{ background: "#2a2f36", boxShadow: "0 2px 6px #333" }}>
          ...
          <Grid container>
            <Grid item xs={8} sx={{ display: "flex", alignItems: "center" }}>
              ...
              <ul className="hover_text_underline">
                <Typography component="li" sx={{ marginRight: "16px" }} letterSpacing={1.5}>
                  <LinkTo to="lessonlist">レッスンリスト</LinkTo>
                </Typography>
                <Typography component="li" sx={{ marginRight: "16px" }} letterSpacing={1.5}>
                  <LinkTo to="history">学習レコード</LinkTo>
                </Typography>
